# Домашнее задание к занятию "`Домашнее задание к занятию «Git»`" - `Казанцева Елена`
...
`В качестве ответа добавляю ссылку на сделанный коммит в данный md-файл с решением.`

1. `[First commit](https://github.com/ElenaKazantseva/hw-git-1/commit/461e4e909894bfbb7787d6e092feb78cd27f4d44)`
